...
def main():
	...
	train_generator = train_datagen.flow_from_directory(train_dir, target_size=(150, 150), class_mode='sparse', color_mode= 'rgb')
   ...
   #model.fit(dataset, epochs=5, steps_per_epoch=5)
	...
	history = model.fit_generator(
      ...
      epochs=15,validation_data=validation_generator,validation_steps=50)
